...
for mtx in row_size:
    ...
    for tn in thread_numbers:
        filename = f"output_2/{tn}_{mtx}.bgn"
        try:
        ...
        if m:
            ...
            array_of_total_times.append(time_ms)
        else:
    ...
    plt.grid()
    plt.savefig(f"pics_2/{mtx}/my_2_times.png", dpi=150, bbox_inches='tight')
